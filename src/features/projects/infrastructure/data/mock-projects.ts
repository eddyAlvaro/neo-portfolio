...
export const projectsMocks: Project[] = [
  ...
  },
  {
    ...
    "description": "Integrated auction solution featuring an event-driven backend, a marketplace platform, and a high-performance landing page. Contributed to core feature development and direct client requirement orchestration.",
    ...
    "devLog": {
      "challenge": "Implementing real-time synchronization and strict data consistency across a distributed auction system with multiple stakeholders.",
      "solution": "Developed core modules using Event Sourcing and CQRS to ensure auditability, while maintaining direct communication with clients to translate business needs into technical features across the full stack.",
      "architectureSnippet": "Client Needs -> Full-Stack Implementation [Nuxt 3 + NestJS] -> Event-Driven Core -> Scalable Infrastructure"
    },
    "githubUrl": "",
    "demoUrl": "https://deocasion.pe/",
    "liveDisclaimer": "The current live version might include external updates beyond my direct contributions and system maintenance."
  },
  {
    id: "ambientar",
  ...
  },
  {
    id: "innovahope",
    title: "Innovahope",
    description: "Next-gen clinical assessment and physical rehabilitation management system, orchestrating complex medical data into actionable health insights.",
    ...
    devLog: {
      challenge: "Handling multi-dimensional clinical assessments (WOMAC, PHQ-9, SF-36) and synchronizing asynchronous medical reporting with AWS-backed assets in a legacy PHP environment.",
      solution: "Built a modularized service architecture to decouple assessment arithmetic from persistence, paired with a custom Cron-driven report generator via Dompdf and Sharp chart visualizations for real-time patient progress tracking.",
      architectureSnippet: "Controller (Request Data) -> AssessmentService (Logic/Scoring) -> Repository (Persistence) -> AWS/S3 (Storage/Assets) -> Twig (PDF Rendering)"
    },
    githubUrl: "",
...
export const levelProgressMock: LevelProgress = {
  currentLevel: 42,
  currentXP: 9500,
  nextLevelXP: 12000,
  totalXP: 156800,
